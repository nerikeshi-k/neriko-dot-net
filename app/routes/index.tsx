      ...
      <div className="max-w-lg mx-auto px-5 py-16 space-y-16">
        ...
        <section className="flex flex-col items-center text-center space-y-5">
          <img
            src={icon}
            alt="@nerikeshi_k"
            className="w-24 h-24 rounded-2xl ring-2 ring-red-400/40 ring-offset-2 ring-offset-neutral-950"
          />
          <div>
          ...
          <div className="flex gap-3">
            ...
            >
              <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M9.56 18V8.15M7.56 18V9.63M5.56 18v-6.3M3.56 18v-4.5M1.56 18v-2.7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
              </svg>
            </SocialIcon>
            <SocialIcon
        ...
        <section>
          ...
          <div className="rounded-xl border border-neutral-700 bg-neutral-900/30 px-5">
            <LinkRow href="mailto:nerikeshik@gmail.com" label="Mail" value="nerikeshik@gmail.com" />
            <LinkRow href="https://x.com/nerikeshi_k" label="X" value="@nerikeshi_k" />
            <div className="py-3">
